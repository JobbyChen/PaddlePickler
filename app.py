...
def choose_side_image(paddle, front):
    ...
    # Only show side/detail if the URL actually looks like a side/detail view.
    # This prevents two front views from appearing side-by-side.
    if not looks_like_side_view(side):
        return ""
